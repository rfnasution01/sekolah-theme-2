...
export function ProfilVisi({
  ...
  return (
    <div className="flex w-full flex-col gap-24 rounded-2xl px-64 shadow phones:p-32">
      ...
      <div className="flex w-full flex-col gap-12">
        <p className="font-roboto text-[3rem] uppercase text-primary-500">
          {profil?.profil?.[0]?.jenis} Pendidikan {sekolah}
        </p>
        <blockquote className="text-center font-roboto text-[4rem]">
